...
if(!user){alert("Please login first");window.location.href="user.html";return;}
...
document.getElementById("logoutBtn").onclick=()=>{localStorage.removeItem("currentUser");window.location.href="user.html";};
...
document.getElementById("photoList").innerHTML="";document.getElementById("photoList").appendChild(img);};
